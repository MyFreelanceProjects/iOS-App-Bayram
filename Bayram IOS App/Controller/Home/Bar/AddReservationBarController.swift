//
//  AddReservationBarController.swift
//  Bayram IOS App
//
...
class AddReservationBarController: BaseVC {
    var dateAndPersons = [
        "date" : "Date",
        "time" : "Time",
        "firstPerson" : "0",
...
extension AddReservationBarController: UITableViewDataSource, UITableViewDelegate {
